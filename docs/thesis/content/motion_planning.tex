...
\begin{figure}[!ht]
    ...
    {
        \includegraphics[height=48mm]{figures/raw/jpeg/collision_cone_point_circle.jpg}
        \label{collision_cone_point_circle}
    }
    \subfloat[Between point and irregular geometry]
    {
        \includegraphics[height=48mm]{figures/raw/jpeg/collision_cone_point_irregular_geometry.jpg}
...
\begin{figure}[!ht]
    ...
    {
        \includegraphics[height=72mm]{figures/raw/jpeg/traj_round_sharp_peak.jpg}
        \label{traj_round_sharp_peak}
    }
    \subfloat[Rounding curves]
    {
        \includegraphics[height=72mm]{figures/raw/jpeg/traj_round_curve.jpg}
...
\begin{figure}[!ht]
    ...
    {
        \includegraphics[height=60mm]{figures/raw/jpeg/rviz_straight_traj_static_object_straight_actuation.jpg}
        \label{straight_actuation}
    }
    \subfloat[Curved actuation]
    {
        \includegraphics[height=60mm]{figures/raw/jpeg/rviz_straight_traj_static_object_curved_actuation.jpg}
...
This publication happens on topic \textit{/vrcar/manual\_control}, using \textit{ackermann\_msgs/AckermannDrive} \cite{ros_msg_AckermannDrive} messages.
